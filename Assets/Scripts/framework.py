...
class Player():
    ...
    def draw_health_bar(self, display):
        ...
        pygame.draw.rect(display, (104,94,103), (19, 19, 17  , 184))
        pygame.draw.rect(display, (55,64,60), (22, 20, 10  , 180))
        pygame.draw.rect(display, (255,0,0), (22,  20 + 180 * (1 - ratio) , 10  , 180 - 180 * (1 - ratio) ))
